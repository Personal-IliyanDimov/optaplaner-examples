...
public final class ExpertScheduleStrengthComparator implements Comparator<ExpertSchedule> {
    ...
    private final Comparator<ExpertSchedule> esComparator = new InternalComparator();
    ...
    private static class InternalComparator implements Comparator<ExpertSchedule> {
        @Override
        public int compare(ExpertSchedule es1, ExpertSchedule es2) {
            int result = Comparator
                    .nullsFirst(Comparator.comparingLong(this::expertSkills))
        ...
        private long expertSkills(Expert expert) {
